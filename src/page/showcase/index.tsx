...
/**
 * Every field type in a single view, all joining the same form by name.
 *
 * Nothing here imports a FormController: `form={FORM}` is an id resolved
 * through the register published by `<FormProvider>`.
 */
export function Showcase() {
    return (
        <div className="showcase">
            <header className="showcase__head">
                <h1>slz-lib-v5 — tous les types de champ</h1>
                <p>
                    Chaque champ affiche ses flags en direct. Le compteur <code>↻</code> montre
                    qu'un champ ne rerender que lorsque son propre état change.
                </p>
            </header>

            <form className="showcase__grid" onSubmit={(event) => event.preventDefault()}>
                <section className="panel">
                    ...
                    <TextField
                        ...
                        hint="Validation asynchrone — le flag `loading` apparaît pendant l'appel"
                    />
                    ...
                    <TextField
                        ...
                        hint="Prefill API : verrouillé et `loading` au montage, reste `pristine`"
                    />
                ...
                <section className="panel">
                    ...
                    <TextField
                        ...
                        hint="Piloté par le flag `invisible` — visible seulement si Marque = Autre"
                    />
